...
@application.route('/room_builder')
def room_builder():
    return render_template('room_builder.html')


@application.route('/grid_list_demo')
def grid_list_demo():
    return render_template('gridListDemo.html')


@application.route('/square_grid_demo')
def square_grid_demo():
    return render_template('squareGrid.html')


# NOTE END MAIN ROUTES
